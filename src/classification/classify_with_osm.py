...
def transform_csv(df, with_cells, output_csv):
    ...
    try:
        df = df[["image", "longitude", "latitude", 
                 "cluster_label_country", 
                 "cluster_label_admin1", 
                 "cluster_label_admin2",
                 "image_base"]]
        df.rename(columns={
                "cluster_label_country": "country_id",
                "cluster_label_admin1": "admin1_id",
                "cluster_label_admin2": "admin2_id"
                           }, inplace=True)
